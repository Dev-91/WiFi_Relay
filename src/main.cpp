...
void handleLEDon() { 
 ...
 server.send(200, "text/json", "ON"); //Send ADC value only to client ajax request
}

void handleLEDoff() { 
 Serial.println("Relay off page");
 digitalWrite(LED, LOW); //LED off
 server.send(200, "text/json", "{\"operation\":\"OFF\"}"); //Send ADC value only to client ajax request
}
//==============================================================
//                  SETUP
//==============================================================
void setup(void){
  ...
  server.on("/RelayOn", handleLEDon); //as Per  <a href="ledOn">, Subroutine to be called
